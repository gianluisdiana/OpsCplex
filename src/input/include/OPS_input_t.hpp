 ...
 *
 * @brief File containing the implementation of the graph structure for the O.P.S.
 *
...
namespace emir {
    ...
    public:
        ...
        inline virtual const std::vector<int> &get_Jk(int k) const { return instance_.get_Jk(k); }
        inline virtual const std::vector<std::vector<int>> &get_Kj(void) const { return instance_.get_Kj(); }
        ...
        inline const std::vector<int> &get_arcs_k(int k) const { return arcs_k_[k]; }
        ...
        inline const std::vector<int> &get_succ_inx(int k, int i) const { return succ_inx_(k + 1, i + 1); }
        ...
        const std::vector<int> &get_nodes(int k) const { return nodes_k_[k]; }
        ...
        void get_path(const std::vector<int> &v, int k, std::vector<int> &arcs, std::vector<bool> &visited) const;
        void get_mpath(const std::vector<int> &v, int k, std::vector<int> &arcs, std::vector<bool> &visited) const;
    ...
    protected:
        ...
        void update_structures(int k, int Ji, int Jj, int &l, GOMA::matrix<int> &A_inv, std::vector<int> &arcs_k, std::vector<int> &nodes);
