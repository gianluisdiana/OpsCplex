...
template<size_t N = 64> class small_bitset_t {
 public:
  block_type block_;
 ...
 public:
  ...
  small_bitset_t(const small_bitset_t &bs) : block_(bs.block_) {}

  small_bitset_t(const block_type &b) : block_(b) {}

  small_bitset_t(const std::vector<int> &b) : block_(0x0) {
